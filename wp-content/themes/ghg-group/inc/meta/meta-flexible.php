					...
					'Hero'         => [
						...
						'sub_fields' => [
							...
							[
								...
								'label'        => 'Title ',
								'type'         => 'text',
								'instructions' => 'Specify a section title (defaults to page title)',
								'wrapper'      => [
									'width' => 50
								]
							],
							...
							[
								...
								'label'        => 'Ticker Text',
								'type'         => 'text',
								'instructions' => 'Specify scrolling ticker text (leave blank to hide feature)',
							],
						],
					],
					...
					'Ticker'       => [
						...
						'sub_fields' => [
							[
								...
								'default_value' => 50,
								'instructions'  =>
									'Select a speed between 10 and 100 (the number of entries will effect the visible speed)',
							],
							[
								'key'          => $prefix . '7a1a3bfb9d',
								'name'         => 'entries',
								'label'        => 'Ticker Entries',
								'type'         => 'gallery',
								'instructions' =>
									'Select multiple images to display as an automated ticker',
							],
						],
					],
					...
					'Checklist'    => [
						...
						'sub_fields' => [
							...
							[
								...
								'instructions' => 'Configure up to 8 list entries',
								'sub_fields'   => [
									[
										...
										'label'        => 'Text',
										'type'         => 'text',
										'instructions' => 'Specify list entry text',
									]
								]
							],
						],
					...
					'Blocks'       => [
						...
						'sub_fields' => [
							...
							[
								...
								'max'          => 4,
								'button_label' => 'Add Entry',
								'instructions' => 'Configure up to 4 blocks of content',
								'sub_fields'   => [
									[
					...
					'Grid'         => [
						...
						'sub_fields' => [
							...
							[
								...
								'max'          => 9,
								'button_label' => 'Add Entry',
								'instructions' => 'Configure up to 9 grid entries',
								'sub_fields'   => [
									[
							...
							[
								...
								'sub_fields'   => [
									...
									[
										...
										'label'        => 'Title',
										'type'         => 'text',
										'instructions' => 'Specify a card title',
										'wrapper'      => [
											'width' => 23
										]
									],
							...
							[
								...
								'sub_fields'   => [
									[
										...
										'label'        => 'Image',
										'type'         => 'image',
										'instructions' => 'Select an image or icon',
										'preview_size' => 'acf_thumb',
										'wrapper'      => [
											'width' => 33
										]
					...
					'WYSIWYG'      => [
						...
						'sub_fields' => [
							[
								...
								'label'        => 'Content',
								'type'         => 'wysiwyg',
								'instructions' => 'Specify content (HTML allowed)',
							],
						],
					],
					...
					'Snippet'      => [
						...
						'sub_fields' => [
							[
								...
								'label'        => 'Content',
								'type'         => 'post_object',
								'instructions' => 'Select which snippet content to display',
								'post_type'    => 'snippet'
							],
						],
					],
