...
<div class="<?php echo esc_attr( $base ); ?>">
	<div class="<?php echo esc_attr( $base ); ?>__image-wrap">
		...
		<svg class="<?php echo esc_attr( $base ); ?>__image-cut" viewBox="0 0 78 84" fill="none"
			 xmlns="http://www.w3.org/2000/svg">
			<path d="M78 84L0 84L78 0L78 84Z" fill="#E8AF5F"/>
		</svg>
	</div>
	<article class="<?php echo esc_attr( $base ); ?>__article">
		<h5 class="<?php echo esc_attr( $base ); ?>__headline"><?php echo the_title() ?></h5>
		<span class="<?php echo esc_attr( $base ); ?>__excerpt"><?php the_excerpt(); ?></span>
		<a href="esc_attr" class="<?php echo esc_attr( $base ); ?>__link">
			View Case Study
		</a>
	</article>
</div>
