...
<article class="<?php echo esc_attr( $base ); ?>__article">
	...
	if ( ! empty( $card['Details']['Supporting_content'] ) ) :
		echo '<p class="' . esc_attr( $base ) . '__supporting">' . $card['Details']['Supporting_content'] . '</p>';
	endif;
	if ( ! empty( $card['Details']['additional_content'] ) ) :
		echo '<p class="' . esc_attr( $base ) . '__additional">' . $card['Details']['additional_content'] . '</p>';
	endif;
	?>
</article>
<?php echo $end; ?>
