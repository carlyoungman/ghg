...
$testimonial =
	$args['data']['testimonial'] ?? (get_sub_field('testimonial') ?? []);
$quote = $args['data']['quote'] ?? (get_sub_field('quote') ?? []);
?>
			...
			<div class="<?php echo esc_attr($base); ?>__grid">
				<div>
					...
					<?php if ($testimonial['title']): ?>
						<p class="<?php echo esc_attr($base); ?>__text">
							...
							<?php echo esc_html($testimonial['title']); ?></p>
					<?php endif; ?>
