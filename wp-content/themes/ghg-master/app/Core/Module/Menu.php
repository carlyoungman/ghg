...
class Menu
{
	...
	{
		return [
			'primary' => esc_html__('Primary Navigation', 'boilerplate-theme'),
			'mobile' => esc_html__('Mobile Navigation', 'boilerplate-theme'),
			'our-brands' => esc_html__('Our brands', 'boilerplate-theme'),
			'our-company' => esc_html__('Our company', 'boilerplate-theme'),
			'legal' => esc_html__('Legal', 'boilerplate-theme'),
			'products' => esc_html__('Products', 'boilerplate-theme'),
		];
	}
